...
<img class="embed-img" src="{{ site.image_base_url }}/html-css/css-syntax.jpg" alt="CSS Syntax" />
...
- It consists of: _margins, borders, padding, and the actual content_.
  ...
  <img class="embed-img" src="{{ site.image_base_url }}/html-css/box-model.jpg" alt="Box Model" />
...
- Following image will help you understand the _overlapping concept_.
  ...
  <img class="embed-img" src="{{ site.image_base_url }}/html-css/z-index.jpg" alt="Z-index" >
...
> > <img class="embed-img" src="{{ site.image_base_url }}/html-css/sample-page.jpg" >
> >
> {: .solution}
{: .challenge}
...
> >
> > The web page should look like below:
> > <img class="embed-img" src="{{ site.image_base_url }}/html-css/bootstrap-like-btns.jpg" >
> >
> {: .solution}
{: .challenge}
